...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='uuid_user_1',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='uuid_user_1', to='allonsy_main.UserExtension'),
        ),
        migrations.AddField(
            model_name='relationuserconnection',
            name='uuid_user_2',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='uuid_user_2', to='allonsy_main.UserExtension'),
        ),
        migrations.AddField(
