...
urlpatterns = [
    ...
    url(r'^user/(?P<username>\w+)/interactions/connect/$', views.user_connect, name='do_user_connect'),
    ...
    url(r'^user/(?P<username>\w+)/interactions/$', views.get_user_interactions, name='do_get_user_interactions'),
    url(r'^user/(?P<username>\w+)/interactions/reply/(?P<uuidmsg>[^/]+)/$', views.send_reply_message, name='do_send_reply_message'),
    url(r'^user/(?P<username>\w+)/interactions/send/$', views.send_message, name='do_send_message'),
    url(r'^user/(?P<username>\w+)/interactions/status/(?P<status>\w+)/(?P<uuidmsg>[^/]+)/$', views.update_msg_status, name='do_update_msg_status'),
    url(r'^user/(?P<username>\w+)/interactions/sent/$', views.do_get_user_sent, name='do_get_user_sent'),
    url(r'^user/(?P<username>\w+)/inv-connections/$', views.get_user_connection_invites, name='get_user_connection_invites'),
    url(r'^user/(?P<username>\w+)/inv-roommates/$', views.get_user_roommate_invites, name='get_user_roommate_invites'),
    ...
    url(r'^user/(?P<username>\w+)/roles/(?P<status>\w+)/(?P<role>\w+)$', views.roles_do_update_duty_status, name='roles_do_update_duty_status'),
    ...
    url(r'^user/(?P<username>\w+)/roles/a/(?P<uuidparentnode>[^/]+)/$', views.do_approve_wf_instance, name='do_approve_wf_instance'),
    ...
    url(r'^user/(?P<username>\w+)/roles/x/(?P<uuidparentnode>[^/]+)/$', views.check_wf_before_approve, name='check_wf_before_approve'),
    ...
    url(r'^create/epoch/do/$', views.do_add_epoch, name='do_add_epoch'),
    ...
    url(r'^assoc/usr/0/loc/0/$', views.assoc_user_loc_res_init, name='assoc_user_loc_res_init'),
    url(r'^assoc/usr/(?P<userpk>\w+)/loc/(?P<uuidlocnode>[^/]+)/$', views.check_if_loc_residence, name='check_if_loc_residence'),
    url(r'^assoc/usr/(?P<userpk>\w+)/loc/(?P<uuidlocnode>[^/]+)/do/$', views.do_assoc_loc_residence, name='do_assoc_loc_residence'),
