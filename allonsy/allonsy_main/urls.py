...
urlpatterns = [
    ...
    url(r'^(?P<account>\w+)/user/(?P<username>\w+)/$', views.resolve_user_url, name='resolve_user_url'),
    ...
    url(r'^(?P<account>\w+)/user/(?P<username>\w+)/interactions/$', views.do_get_user_interactions, name='do_get_user_interactions'),
    ...
    url(r'^(?P<account>\w+)/user/(?P<username>\w+)/alerts/$', views.do_get_user_alerts, name='do_get_user_alerts'),
    url(r'^user/(?P<username>\w+)/alerts/status/(?P<status>\w+)/(?P<uuidmsg>[^/]+)/$', views.do_update_alert_status, name='do_update_alert_status'),
    url(r'^(?P<account>\w+)/account-admin/$', views.user_admin, name='user_admin'),
